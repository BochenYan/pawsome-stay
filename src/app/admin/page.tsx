    ...
    <div style={{minHeight:"100vh",background:"#f5f0e8",padding:"3rem 4rem"}}>
      ...
      {loading ? (
        ...
        <div style={{display:"flex",flexDirection:"column",gap:"1rem"}}>
          {bookings.map((b) => (
            <div key={b.id} style={{background:"#fffdf8",borderRadius:"1.25rem",padding:"1.5rem 2rem",border:"1px solid rgba(122,92,68,0.1)",display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr auto",gap:"1.5rem",alignItems:"center"}}>
              <div>
              ...
              <div>
                <div style={{fontWeight:600,color:"#2a2018",marginBottom:"0.2rem"}}>{b.petName} ({b.petType})</div>
                <div style={{fontSize:"0.8rem",color:"#7a6e62"}}>{b.service}</div>
              </div>
              <div>
                <div style={{fontSize:"0.8rem",color:"#7a6e62",marginBottom:"0.2rem"}}>Dates</div>
                <div style={{fontWeight:500,color:"#2a2018",fontSize:"0.9rem"}}>{b.startDate} → {b.endDate}</div>
              </div>
              <div style={{fontSize:"0.8rem",color:"#7a6e62"}}>{b.notes || "—"}</div>
