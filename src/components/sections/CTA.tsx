...
export default function CTA() {
  ...
  return (
    <div style={{padding:"0 4rem 6rem",background:"#f5f0e8"}}>
      <section id="book" style={{background:"linear-gradient(135deg,#c4704f 0%,#a85a3a 100%)",borderRadius:"2rem",padding:"4rem",textAlign:"center",position:"relative",overflow:"hidden"}}>
